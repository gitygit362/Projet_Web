    ...
    <main>
        <form name="GE_creation"  action="" method="post">
            <fieldset>
                ...
                <input type="text" id="secteur_entreprise" name="secteur_entreprise" required>
                ...
                <button class="addCompetence" type="button" onclick="AddLocaliteEnt()">ajouter une compétence</button>
                <button class="button" type="button" onclick="redirectToAccueilGE_FromCreate()">Modifier</button>
            </fieldset>
        </form>
    </main>
    <footer>
