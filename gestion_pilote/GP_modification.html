...
<body>
    <header>
        ...
        <h1 class="GE">Modification pilote</h1>
    </header>
    <div class="back_to_hub">
    <div class="text_bth" onclick="redirectToEdit_GP()">retour</div>
    </div>
    <main>
        <form name="GE_creation"  action="" method="post">
            <fieldset>
                ...
                <button class="button" type="button" onclick="redirectToAccueilGP()">Modifier</button>
            </fieldset>
        </form>
    </main>
    <footer>
